...
public class QuizStudentMapper {
    ...
    /**
     * Map Quiz → QuizDTO (cho Student - ẩn đáp án)
     */
    public static QuizDTO toQuizDTO(Quiz quiz) {
        ...
        if (quiz.getQuestions() != null) {
            questions = QuestionMapper.toDTOsForStudent(quiz.getQuestions());
        }
    ...
    /**
     * Map Quiz → QuizBasicInfoDTO (cho Student)
     */
    ...
    /**
     * Map Quiz → QuizSummaryDTO (cho Student)
     */
    ...
    /**
     * Map Quiz → QuizStatusDTO (cho Student)
     */
    ...
    /**
     * Map List<Quiz> → List<QuizSummaryDTO> (cho Student)
     */
    public static List<QuizSummaryDTO> toSummaryDTOs(List<Quiz> quizzes) {
        if (quizzes == null) return null;

        return quizzes.stream().map(QuizStudentMapper::toSummaryDTO).collect(Collectors.toList());
    }

    /**
     * Map List<Quiz> → List<QuizStatusDTO> (cho Student)
     */
    public static List<QuizStatusDTO> toStatusDTOs(List<Quiz> quizzes) {
        if (quizzes == null) return null;

        return quizzes.stream().map(QuizStudentMapper::toStatusDTO).collect(Collectors.toList());
    }
