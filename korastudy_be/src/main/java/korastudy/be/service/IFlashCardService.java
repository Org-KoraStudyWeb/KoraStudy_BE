...
public interface IFlashCardService {
    ...
    // Cập nhật bộ flashcard hệ thống (admin)
    void updateSystemFlashcardSet(Long setId, SetCardRequest request);
    
    // Xóa bộ flashcard hệ thống (admin)
    void deleteSystemFlashcardSet(Long setId);
